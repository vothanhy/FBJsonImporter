<div class="wrap">
	...
	<form method="post" name="jsonimporter" id="jsonimporter" class="validate" novalidate="novalidate" onsubmit="return jsonimporter_validate();" enctype="multipart/form-data">
	...
	<p class="submit">
		...
		<input type="submit" name="jsonimporter_submit" id="jsonimporter_submit" class="button button-primary" value="Import">
	</p>
</form>
</div>
<script>
